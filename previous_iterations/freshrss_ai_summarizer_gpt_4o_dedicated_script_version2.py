...
# Initialize `rich` console for beautiful Markdown output
console = Console()
...
def display_analysis():
    """
    Fetch articles from FreshRSS, analyze them, and display summaries in terminal-friendly markdown format.
    """
    ...
    console.print(Markdown(consolidated_summary))
